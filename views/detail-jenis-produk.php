                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>Nama</th>
                                        <td><?php echo $jenis_produk['nama'] ?></td>
                                    </tr>
                                    <tr>
                                        <th>Deskripsi</th>
                                        <td><?php echo $jenis_produk['deskripsi'] ?></td>
                                    </tr>
                                </table>
                                <div class="mt-3">
                                    <a href="list-jenis-produk.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
                                    <a href="edit-jenis-produk.php?id=<?php echo $jenis_produk['id'] ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                    <a href="delete-jenis-produk.php?id=<?php echo $jenis_produk['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
