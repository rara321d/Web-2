...
<fieldset class="border border-dark p-3 rounded" style="background-color: lightyellow;">
    <legend class="float-none w-auto px-3 fw-bold h3">Form Refistrasi IT Club Data Science</legend>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*011243356" type="text" class="form-control" required="required" pattern="[0-9]{10}" tittle="NIM harus 10 Digit Angka">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Yumna Dzakirah" type="text" class="form-control" required="required" minlenght="3" maxlenght="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="jenis_kelamin" id="jenis_kelamin_0" type="radio" required="required" class="custom-control-input" value="Laki-Laki" required="required" checked> 
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      foreach($ar_skill as $nama => $nilai){
        ...
        echo "<input name='skills[]' id='skills_$nama' type='checkbox' class='custom-control-input' value='$nama' $nilai>";
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="email" name="email" placeholder="*Yumnadzakirah377@gmail.com" type="email" class="form-control" required="required">
      </div>
    </div>
  </div> 
  <div class="form-group row">
